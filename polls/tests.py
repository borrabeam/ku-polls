...
class QuestionModelTests(TestCase):
    ...
    def test_is_published_with_past_question(self):
        """
        is_published() return False for questions whose pub_date is older than 7 days.
        """
    ...
    def test_is_published_with_recent_question(self):
        """
        is_published() return True for question whose pub_date is not within 2 hours.
        """
    ...
    def test_can_vote_with_past_question(self):
        """
        can_vote() return False for question pub_date is older than end_date
        """
